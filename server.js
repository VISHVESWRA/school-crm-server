...
app.post('/api/teachers', async (req, res) => {
    const oldList = JSON.parse(fs.readFileSync("src/jsonFile/teachersList.json", "utf8"));
    oldList.push(req.body);
    await fs.writeFileSync("src/jsonFile/teachersList.json", JSON.stringify(oldList, null, 2));
